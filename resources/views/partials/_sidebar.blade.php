...
>
    ...
    <nav class="space-y-2">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-2 py-2.5 px-4 rounded transition duration-200 sidebar-link {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
        ...
        <div>
            ...
            {{-- Link ke Blokir/Suspend bisa jadi bagian dari halaman Data Pengguna --}}
        </div>
